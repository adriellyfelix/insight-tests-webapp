...
const Login: React.FC = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#F8F8FC' }}>
      {/* Navbar */}
      <AppBar position="static" elevation={0} sx={{ bgcolor: '#F6F6FB', color: '#3B3472', boxShadow: 'none', py: 2 }}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} style={{ width: '100%' }}>
              <TextField
                ...
                InputProps={{ disableUnderline: true, sx: { bgcolor: '#E6E6FA', borderRadius: 2, color: '#3B3472', fontSize: 18, px: 2, height: 48 } }}
                InputLabelProps={{ style: { color: '#3B3472', fontWeight: 500 } }}
              />
              <TextField
                label="Senha"
                type="password"
