...
import type { Projeto, CasoDeTeste, SuiteDeTeste, Bug, ExecucaoDeTeste } from '../types'
...
export const projetosApi = {
  ...
  criar: (projeto: Omit<Projeto, 'id'>) => api.post<Projeto>('/projetos', projeto),
  atualizar: (id: string, projeto: Partial<Projeto>) => api.put<Projeto>(`/projetos/${id}`, projeto),
...
export const casosDeTesteApi = {
  ...
  criar: (casoDeTeste: Omit<CasoDeTeste, 'id'>) => api.post<CasoDeTeste>('/casos-de-teste', casoDeTeste),
  atualizar: (id: string, casoDeTeste: Partial<CasoDeTeste>) => api.put<CasoDeTeste>(`/casos-de-teste/${id}`, casoDeTeste),
...
export const suitesDeTesteApi = {
  ...
  criar: (suiteDeTeste: Omit<SuiteDeTeste, 'id'>) => api.post<SuiteDeTeste>('/suites-de-teste', suiteDeTeste),
  atualizar: (id: string, suiteDeTeste: Partial<SuiteDeTeste>) => api.put<SuiteDeTeste>(`/suites-de-teste/${id}`, suiteDeTeste),
...
export const bugsApi = {
  ...
  atualizar: (id: string, bug: Partial<Bug>) => api.put<Bug>(`/bugs/${id}`, bug),
...
export const execucoesApi = {
  ...
  criar: (execucao: Omit<ExecucaoDeTeste, 'id'>) => api.post<ExecucaoDeTeste>('/execucoes-de-teste', execucao),
  atualizar: (id: string, execucao: Partial<ExecucaoDeTeste>) => api.put<ExecucaoDeTeste>(`/execucoes-de-teste/${id}`, execucao),
